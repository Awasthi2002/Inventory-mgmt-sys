...
export function OpProductDeliveredTable() {
      ...
      renderRowActions: ({ row }) => (
          <Box sx={{ display: 'flex', gap: '1rem' }}>
            <Button
              ...
              variant="outlined"
              color="primary"
              onClick={() => navigate(`/operator/OpProductDeliveredEdit/${row.original._id}`)}
            >
              Edit
            </Button>
          ...
          >
            ...
            >
              ...
              <Button
                          variant="contained"
                          startIcon={<AddIcon />}
                          onClick={() => navigate('/operator/OpProductDeliveredForm')}
                          sx={{
                            bgcolor: '#4F46E5',
...
export default OpProductDeliveredTable;