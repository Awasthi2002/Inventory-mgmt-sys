...
export function AddOperator() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const successMessage = `Operator registered successfully. Generated password: ${response.data.generatedPassword}`;
      ...
      Swal.fire({
        ...
        navigate('/admin/operators/manageOperators');
      });
        ...
        <CardContent className="p-4">
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            {responseMessage && (
              <Typography
                className={
                  responseMessage.includes('Operator registered successfully')
