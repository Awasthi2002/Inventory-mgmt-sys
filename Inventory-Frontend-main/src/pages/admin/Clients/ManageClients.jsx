...
export function ClientsManage() {
  ...
  const handleAddClient = () => {
    navigate('/admin/clients/addClients');
  }
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardBody>
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center">
              <p className="text-black-400 font-bold">client</p>
              <svg
      ...
      <Card>
        <CardBody>
          <div className="flex justify-between items-center">
            <div className="flex items-center">
              <p className="font-bold text-lg">Manage Clients</p>
            </div>
