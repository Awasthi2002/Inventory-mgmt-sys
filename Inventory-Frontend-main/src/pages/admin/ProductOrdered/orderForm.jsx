...
export function OrderForm({ onSubmit, initialData = null }) {
  ...
  useEffect(() => {
    if (formData.brandName) {
      ...
      if (selectedBrand) {
        ...
        setAvailableEmployees(selectedBrand.employees);
      }
    } else {
      setAvailableProducts([]);
      setAvailableEmployees([]);
    }
  }, [formData.brandName, brandsData]);
                        ...
                        >
                          ...
                          {accountDetails.map((account) => (
                            <MenuItem key={account._id} value={account._id}>
                              {account.name} - Mobile No. {account.phoneNumber} - {account.paymentType} - {
